...
Rectangle vet1 = new Rectangle(304,4,4,28);
Rectangle hoz2 = new Rectangle(277,32,28,4);
...
// adds objects to the screen      
      mazeOnePane.getChildren().addAll(txtPlayerTimer,lblTimerDesc,lblTimerBorder,rectStart,rectEnd,hoz2,vet1);
...
// bottom horizontal wall collision	   
	   ...
	   if(up == true || down == true || left == true || right == true) {
		   if(rectPlayer.getBoundsInParent().intersects(q1.getBoundsInParent())) {
			   ...
			   System.out.println(stack.size());
		   }else if(rectPlayer.getBoundsInParent().intersects(vet1.getBoundsInParent())) {
			   rectPlayer.setX(rectPlayer.getX()+5);
	   	   }else if(rectPlayer.getBoundsInParent().intersects(hoz2.getBoundsInParent())) {
	   		   rectPlayer.setY(rectPlayer.getY()+5);
	   	   }
		   
		   if(stack.isEmpty()) {
			   mazeOnePane.getChildren().remove(vet1);
			   mazeOnePane.getChildren().remove(hoz2);
