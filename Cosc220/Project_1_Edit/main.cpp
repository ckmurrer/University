/*
  ...
  I was unable to figure out how to fix bugs that were described in the peer review
  as well as fix things such as cursor hangup on blank line and skipping some inputs
  every now and then.

  While trying to update my code my VM crashed and no longer allows me to open up the software
  so I had lost some progress on bug fixing and couldnt remember how to fix the ones I did in the VM
