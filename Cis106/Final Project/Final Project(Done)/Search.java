...
// Adds components to the screem      
      search.add(sep);
      search.add(searchFile);
      search.add(ser);
      search.add(desc);
      search.add(rtn);
// Created the root frame to hold the search panel  
...
// sets the length of both arrays                        
                          ...
                          String[] recipe = new String[run];
                           rw = run *100;
                           b = rh + 400;
// populates JLabel and String array                     
                        for(i=0; i<run;i++){
                           look = br.readLine();
                           look.toString();
//Prints filled arrays on screen                        
